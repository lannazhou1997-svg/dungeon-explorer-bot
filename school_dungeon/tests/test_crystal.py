...
from school_dungeon.game.crystal import CRYSTAL_EXCHANGE_COST, crystal_charm_values_text, equip_crystal_reward, exchange_crystals
...
class CrystalExchangeTests(unittest.TestCase):
    ...
    def test_large_reward_pool_has_requested_rarity_counts(self):
        from school_dungeon.game.crystal import CRYSTAL_REWARDS
