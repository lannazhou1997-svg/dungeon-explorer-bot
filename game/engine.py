...
class GameEngine:
    ...
    MERCHANT_ITEMS = {
        ...
        "ember_hammer": ("旅行商人·余烬战锤", "武器", "攻击 +13｜敏捷 +1", 460, {"attack": 13, "agility": 1}),
        "tide_staff": ("旅行商人·潮音法杖", "武器", "攻击 +15｜幸运 +2", 590, {"attack": 15, "luck": 2}),
        "gear_spear": ("旅行商人·发条破甲枪", "武器", "攻击 +17｜敏捷 +2", 760, {"attack": 17, "agility": 2}),
        "frost_blades": ("旅行商人·霜牙双刃", "武器", "攻击 +20｜敏捷 +3", 980, {"attack": 20, "agility": 3}),
        ...
        "tide_robe": ("旅行商人·潮汐祭衣", "装备", "防御 +7｜幸运 +2", 560, {"defense": 7, "luck": 2}),
        "clock_armor": ("旅行商人·钟摆机关甲", "装备", "防御 +10｜敏捷 +2", 760, {"defense": 10, "agility": 2}),
        "frost_cape": ("旅行商人·霜冠王披", "装备", "防御 +13｜幸运 +3", 990, {"defense": 13, "luck": 3}),
    }
    MERCHANT_POOLS = {
        "药剂": [
